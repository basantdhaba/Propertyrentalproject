...
import { AlertCircle, Home, Check, ArrowLeft } from "lucide-react"
import { Alert, AlertDescription, AlertTitle } from "@/components/ui/alert"
import Link from "next/link"

// Form schema with validation - identical to PropertyListingForm
...
export default function PropertyEditForm({ property, propertyId }: PropertyEditFormProps) {
  ...
  console.log("PropertyEditForm received property:", property)
  ...
  // Set form values when property data is available
  useEffect(() => {
    if (property && !formInitialized) {
      console.log("Setting form values from property:", property)
      ...
      // Map property data to form fields - ensure ALL fields are included
      const propertyData = {
        name: property.name || "",
        propertyType: property.propertyType || property.type || "",
        totalBuildingFloor: property.totalBuildingFloor ? String(property.totalBuildingFloor) : "",
        rentFloor: property.rentFloor ? String(property.rentFloor) : "",
        ...
        rentTo: property.rentTo || "",
        familySize: property.familySize ? String(property.familySize) : "",
        monthlyRent: property.monthlyRent || property.price ? String(property.monthlyRent || property.price) : "",
        ...
        religionPreference: property.religionPreference || false,
        specificReligion: property.specificReligion || "",
        videoLink: property.videoLink || property.youtubeUrl || "",
        createVideo: property.createVideo || false,
      ...
      console.log("Mapped property data for form:", propertyData)

      // Reset form with property data
      form.reset(propertyData)
      setFormInitialized(true)
    }
  }, [property, form, formInitialized])
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      // Update in Firestore
      const { error } = await updateDocument("properties", propertyId, propertyData)
      ...
      <Card className="max-w-4xl mx-auto">
        <CardHeader>
          <div className="flex items-center gap-2 mb-4">
            <Link
              href={isAdmin ? "/admin/property-listings" : "/dashboard"}
          ...
          <CardDescription>Update the property details below. All fields marked with * are required.</CardDescription>
        </CardHeader>
          ...
          <CardContent className="space-y-8">
            ...
            {success && (
              <Alert className="bg-green-50 text-green-800 border-green-200">
                ...
                <AlertDescription>
                  The property has been updated successfully. You will be redirected to the property listings shortly.
                </AlertDescription>
              </Alert>
            )}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    onValueChange={(value) => setValue("rentTo", value)}
                    defaultValue={form.getValues("rentTo")}
                    value={form.getValues("rentTo")}
                  >
                ...
                {religionPreference && (
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <Select
                      ...
                      value={form.getValues("specificReligion")}
                    >
